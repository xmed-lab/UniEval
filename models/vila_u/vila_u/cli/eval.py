...
from vila_u.eval import EVAL_ROOT, TASKS
...
def main() -> None:
    ...
    parser.add_argument("--num_video_frames", "-nf", type=str, default="8")
    ...
    if args.report_to == "wandb":
        ...
        wandb_project = os.environ.get("WANDB_PROJECT", "vila-u-eval")
