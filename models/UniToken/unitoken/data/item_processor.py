...
class FlexARItemProcessor(MMConvItemProcessor):
    ...
    def __init__(
        ...
        self.chameleon_ori_vocab = chameleon_vae_ori.VocabInfo(
            json.load(open(f"models/UniToken/ckpts/chameleon/tokenizer/text_tokenizer.json", encoding="utf8"))["model"]["vocab"]
        )
        ...
        self.chameleon_ori_image_tokenizer = chameleon_vae_ori.ImageTokenizer(
            cfg_path=f"models/UniToken/ckpts/chameleon/tokenizer/vqgan.yaml",
            ckpt_path=f"models/UniToken/ckpts/chameleon/tokenizer/vqgan.ckpt",
            device="cuda",
        )
    ...
    def process_image(self, image) -> Dict:
        ...
        w_grids, h_grids = image.size[0] // self.patch_size, image.size[1] // self.patch_size   # patch_size=32
